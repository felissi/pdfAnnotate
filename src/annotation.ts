...
export class AnnotationFactory {
  ...
  createInkAnnotation(values: {
    ...
    // let params = ParameterParser.parseParameters(values as any)
    const { createDefaultAppearanceStream, ...params } = values;

    let annot: InkAnnotationObj = new InkAnnotationObj(params);
    annot = (<any>Object).assign(annot, this.createBaseAnnotation(params.page));
    annot = (<any>Object).assign(annot, params);
